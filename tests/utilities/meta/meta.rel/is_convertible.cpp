...
constexpr void expect_is_convertible() {
    ...
    static_assert(static_cast<bool>(std::is_convertible<From, To>{}) == e);
    static_assert(noexcept(static_cast<bool>(std::is_convertible<From, To>{})));
    static_assert(std::is_convertible<From, To>{}() == e);
    static_assert(noexcept(std::is_convertible<From, To>{}()));
    static_assert(std::is_same_v<bool, decltype(std::is_convertible<From, To>{}())>);
    static_assert(std::is_same_v<typename std::is_convertible<From, To>::type, std::bool_constant<e>>);
