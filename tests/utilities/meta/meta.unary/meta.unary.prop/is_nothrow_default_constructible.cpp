...
DECLARE_TRAIT_V_READER(is_nothrow_default_constructible_v);

TEST_UNARY_TRAIT_AGAINST_VOID(false, is_nothrow_default_constructible, EVERY_CV);
TEST_UNARY_TRAIT_AGAINST_NULLPTR_T(true, is_nothrow_default_constructible, EVERY_CV);
TEST_UNARY_TRAIT_AGAINST_INTEGRAL(true, is_nothrow_default_constructible, EVERY_CV);
TEST_UNARY_TRAIT_AGAINST_FLOATING_POINT(true, is_nothrow_default_constructible, EVERY_CV);
...
TEST_UNARY_TRAIT_AGAINST_RVALUE_REFERENCE(false, is_nothrow_default_constructible);
TEST_UNARY_TRAIT_AGAINST_MEMBER_OBJECT_POINTER(true, is_nothrow_default_constructible, EVERY_CV);
TEST_UNARY_TRAIT_AGAINST_MEMBER_FUNCTION_POINTER(true, is_nothrow_default_constructible, EVERY_CV);
