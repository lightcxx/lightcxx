...
TEST_UNARY_TRAIT_AGAINST_TYPES(true, has_unique_object_representations, EVERY_CV, int[10],
                               int[10][10], int[], int[][10], int[][10][10]);
...
TEST_UNARY_TRAIT_AGAINST_TYPES(true, has_unique_object_representations, EVERY_CV, UniqueUnion,
                               UniqueUnion[10], UniqueUnion[], UniqueUnion[10][10],
                               UniqueUnion[][10]);
TEST_UNARY_TRAIT_AGAINST_TYPES(false, has_unique_object_representations, EVERY_CV, NotUniqueUnion,
                               NotUniqueUnion[10], NotUniqueUnion[], NotUniqueUnion[10][10],
                               NotUniqueUnion[][10]);
...
TEST_UNARY_TRAIT_AGAINST_TYPES(true, has_unique_object_representations, EVERY_CV, UniqueClass,
                               UniqueClass[10], UniqueClass[], UniqueClass[10][10],
                               UniqueClass[][10]);
TEST_UNARY_TRAIT_AGAINST_TYPES(false, has_unique_object_representations, EVERY_CV, NonUniqueClass,
                               NonUniqueClass[10], NonUniqueClass[], NonUniqueClass[10][10],
                               NonUniqueClass[][10], WithBits, WithBits[10], WithBits[],
                               WithBits[10][10], WithBits[][10]);
