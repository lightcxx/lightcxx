...
constexpr bool test_is_trivially_assignable() {
    ...
    bool b5 = (bool)std::is_trivially_assignable<T, U>{} == e;
    bool b6 = noexcept((bool)std::is_trivially_assignable<T, U>{});
    ...
    bool b10
      = std::is_same_v<typename std::is_trivially_assignable<T, U>::type, std::bool_constant<e>>;
