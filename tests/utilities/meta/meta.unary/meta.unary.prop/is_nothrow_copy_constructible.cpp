...
DECLARE_TRAIT_V_READER(is_nothrow_copy_constructible_v);

TEST_UNARY_TRAIT_AGAINST_VOID(false, is_nothrow_copy_constructible, EVERY_CV);
TEST_UNARY_TRAIT_AGAINST_NULLPTR_T(true, is_nothrow_copy_constructible, EVERY_CV);
TEST_UNARY_TRAIT_AGAINST_INTEGRAL(true, is_nothrow_copy_constructible, EVERY_CV);
TEST_UNARY_TRAIT_AGAINST_FLOATING_POINT(true, is_nothrow_copy_constructible, EVERY_CV);
TEST_UNARY_TRAIT_AGAINST_ARRAY(false, is_nothrow_copy_constructible, EVERY_CV);
TEST_UNARY_TRAIT_AGAINST_POINTER(true, is_nothrow_copy_constructible, EVERY_CV);
...
TEST_UNARY_TRAIT_AGAINST_MEMBER_OBJECT_POINTER(true, is_nothrow_copy_constructible, EVERY_CV);
TEST_UNARY_TRAIT_AGAINST_MEMBER_FUNCTION_POINTER(true, is_nothrow_copy_constructible, EVERY_CV);
TEST_UNARY_TRAIT_AGAINST_ENUM(true, is_nothrow_copy_constructible, EVERY_CV);

// union -- true for const, false for volatile
TEST_UNARY_TRAIT_AGAINST_UNION(true, is_nothrow_copy_constructible, NO_CV);
TEST_UNARY_TRAIT_AGAINST_UNION(true, is_nothrow_copy_constructible, CONST);
TEST_UNARY_TRAIT_AGAINST_UNION(false, is_nothrow_copy_constructible, VOLATILE);
TEST_UNARY_TRAIT_AGAINST_UNION(false, is_nothrow_copy_constructible, CONST_VOLATILE);

// class -- true for const, false for volatile
TEST_UNARY_TRAIT_AGAINST_CLASS(true, is_nothrow_copy_constructible, NO_CV);
TEST_UNARY_TRAIT_AGAINST_CLASS(true, is_nothrow_copy_constructible, CONST);
TEST_UNARY_TRAIT_AGAINST_CLASS(false, is_nothrow_copy_constructible, VOLATILE);
TEST_UNARY_TRAIT_AGAINST_CLASS(false, is_nothrow_copy_constructible, CONST_VOLATILE);
...
TEST_UNARY_TRAIT_AGAINST_TYPES(true, is_nothrow_copy_constructible, NO_CV, NoMoveCtor);
