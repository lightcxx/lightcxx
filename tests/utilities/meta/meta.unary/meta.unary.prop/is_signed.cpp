...
TEST_UNARY_TRAIT_AGAINST_TYPES(true, is_signed, EVERY_CV, signed char, short int, int, long int,
                               long long int, char, wchar_t);
TEST_UNARY_TRAIT_AGAINST_TYPES(false, is_signed, EVERY_CV, bool, unsigned char, unsigned short int,
                               unsigned int, unsigned long int, unsigned long long int, char8_t,
                               char16_t, char32_t);
...
enum [[maybe_unused]] EnumSigned : signed char{es1, es2};
TEST_UNARY_TRAIT_AGAINST_TYPES(false, is_signed, EVERY_CV, EnumSigned, Enum, EnumUnsigned,
                               EnumClass);
