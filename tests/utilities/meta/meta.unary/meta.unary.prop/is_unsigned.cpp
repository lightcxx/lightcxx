...
TEST_UNARY_TRAIT_AGAINST_TYPES(false, is_unsigned, EVERY_CV, signed char, short int, int, long int,
                               long long int, char, wchar_t);
TEST_UNARY_TRAIT_AGAINST_TYPES(true, is_unsigned, EVERY_CV, bool, unsigned char, unsigned short int,
...
TEST_UNARY_TRAIT_AGAINST_TYPES(false, is_unsigned, EVERY_CV, Enum, EnumUnsigned, EnumSigned,
                               EnumClass);
