...
TEST_UNARY_TRAIT_AGAINST_TYPES(false, is_abstract, EVERY_CV, Class, VirtualBase, VirtualDtor,
...
TEST_UNARY_TRAIT_AGAINST_TYPES(true, is_abstract, EVERY_CV, PureVirtualDtor, PureVirtualMethod,
