...
TEST_UNARY_TRAIT_AGAINST_TYPES(false, is_trivially_copy_assignable, NO_CV, const int&,
...
TEST_UNARY_TRAIT_AGAINST_TYPES(true, is_trivially_copy_assignable, NO_CV, int&, volatile int&,
                               int*&, int* volatile&);
...
TEST_UNARY_TRAIT_AGAINST_MEMBER_FUNCTION_POINTER(false, is_trivially_copy_assignable,
                                                 CONST_VOLATILE);
...
TEST_UNARY_TRAIT_AGAINST_TYPES(false, is_trivially_copy_assignable, EVERY_CV, NoCopyAssignOp,
                               NoCopyNoMoveAssignOp, NonTrivialCopyAssignOp,
