...
static_assert(test_add_pointer<int() const, int() const>());
static_assert(test_add_pointer<int() volatile, int() volatile>());
static_assert(test_add_pointer<int() const volatile, int() const volatile>());
