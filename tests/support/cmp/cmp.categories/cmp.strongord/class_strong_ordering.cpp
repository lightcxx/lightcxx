...
TEST(less) {
    ...
    expect_ct_and_rt(static_cast<std::partial_ordering>(std::strong_ordering::less) == std::partial_ordering::less);
    expect_is_noexcept(static_cast<std::partial_ordering>(std::strong_ordering::less));
    ...
    expect_ct_and_rt(static_cast<std::weak_ordering>(std::strong_ordering::less) == std::weak_ordering::less);
    expect_is_noexcept(static_cast<std::weak_ordering>(std::strong_ordering::less));
...
TEST(equal) {
    ...
    expect_ct_and_rt(static_cast<std::partial_ordering>(std::strong_ordering::equal) == std::partial_ordering::equivalent);
    expect_is_noexcept(static_cast<std::partial_ordering>(std::strong_ordering::equal));
    ...
    expect_ct_and_rt(static_cast<std::weak_ordering>(std::strong_ordering::equal) == std::weak_ordering::equivalent);
    expect_is_noexcept(static_cast<std::weak_ordering>(std::strong_ordering::equal));
    expect_ct_and_rt(!(std::strong_ordering::equal == std::strong_ordering::less));
    expect_is_noexcept(std::strong_ordering::equal == std::strong_ordering::less);
...
TEST(equivalent) {
    ...
    expect_ct_and_rt(static_cast<std::partial_ordering>(std::strong_ordering::equivalent) == std::partial_ordering::equivalent);
    expect_is_noexcept(static_cast<std::partial_ordering>(std::strong_ordering::equivalent));
    ...
    expect_ct_and_rt(static_cast<std::weak_ordering>(std::strong_ordering::equivalent) == std::weak_ordering::equivalent);
    expect_is_noexcept(static_cast<std::weak_ordering>(std::strong_ordering::equivalent));
    expect_ct_and_rt(!(std::strong_ordering::equivalent == std::strong_ordering::less));
    expect_is_noexcept(std::strong_ordering::equivalent == std::strong_ordering::less);
...
TEST(greater) {
    ...
    expect_ct_and_rt(static_cast<std::partial_ordering>(std::strong_ordering::greater) == std::partial_ordering::greater);
    expect_is_noexcept(static_cast<std::partial_ordering>(std::strong_ordering::greater));
    ...
    expect_ct_and_rt(static_cast<std::weak_ordering>(std::strong_ordering::greater) == std::weak_ordering::greater);
    expect_is_noexcept(static_cast<std::weak_ordering>(std::strong_ordering::greater));
    expect_ct_and_rt(!(std::strong_ordering::greater == std::strong_ordering::less));
    expect_is_noexcept(std::strong_ordering::greater == std::strong_ordering::less);
    expect_ct_and_rt(!(std::strong_ordering::greater == std::strong_ordering::equivalent));
    expect_is_noexcept(std::strong_ordering::greater == std::strong_ordering::equivalent);
